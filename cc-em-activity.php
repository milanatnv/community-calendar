...
add_filter('em_event_save','cc_record_activity_event_save', 10, 2);
add_filter('em_booking_set_status','cc_record_activity_booking_save', 100, 2);
add_filter('em_booking_save','cc_record_activity_booking_save', 100, 2);
add_filter('em_booking_delete','cc_record_activity_booking_save', 100, 2);

function cc_record_activity_event_save( $result, $EM_Event ){
...
function cc_record_activity_booking_save( $result, $EM_Booking ){
